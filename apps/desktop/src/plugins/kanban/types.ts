...
export const COLUMN_META: Record<string, { label: string; codicon: string; tone: string; help: string }> = {
  triage: { label: 'Triage', codicon: 'inbox', tone: 'var(--ui-text-tertiary)', help: 'Raw ideas — a specifier fleshes out the spec.' },
  todo: { label: 'Todo', codicon: 'circle-outline', tone: 'var(--ui-text-secondary)', help: 'Waiting on dependencies, or unassigned.' },
  scheduled: { label: 'Scheduled', codicon: 'watch', tone: '#a78bfa', help: 'Waiting for a scheduled time to arrive.' },
  ready: { label: 'Ready', codicon: 'play-circle', tone: '#60a5fa', help: 'Dependencies satisfied — assign a profile and the dispatcher runs it.' },
  running: { label: 'Running', codicon: 'sync', tone: '#34d399', help: 'Claimed by a worker — an agent is on it. Set by the dispatcher.' },
  blocked: { label: 'Blocked', codicon: 'error', tone: '#f87171', help: 'The worker asked for human input.' },
  review: { label: 'Review', codicon: 'eye', tone: '#fbbf24', help: 'A review agent is checking the work. Set by the dispatcher.' },
  done: { label: 'Done', codicon: 'pass', tone: 'var(--ui-text-tertiary)', help: 'Completed; dependent children become ready.' },
  archived: { label: 'Archived', codicon: 'archive', tone: 'var(--ui-text-quaternary)', help: 'Hidden from the default board view.' }
}
